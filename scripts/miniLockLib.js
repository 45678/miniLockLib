(function(exports, global) {
    ...
    Base58.decode = function(string) {
        ...
        var input = string.split("").map(function(c) {
            if (Base58.ALPHABET.indexOf(c) === -1) throw "Non-base58 character";
            return Base58.ALPHABET_MAP[c];
        });
        var i, j, bytes = [ 0 ];
        for (i = 0; i < input.length; i++) {
            for (j = 0; j < bytes.length; j++) bytes[j] *= Base58.BASE;
            bytes[0] += input[i];
            var carry = 0;
...
var BLAKE2s = function() {
    function BLAKE2s(digestLength, key) {
        ...
        this.blockLength = 64;
        this.iv = [ 1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225 ];
        if (digestLength <= 0) {
        ...
        var param = [ digestLength & 255, keyLength, 1, 1 ];
...
(function(root, f) {
    "use strict";
    if (typeof module !== "undefined" && module.exports) module.exports.stream = f(require("tweetnacl/nacl-fast")); else root.nacl.stream = f(root.nacl);
})(this, function(nacl) {
    "use strict";
    ...
    function checkArgs(key, nonce, maxChunkLength) {
        ...
        if (maxChunkLength >= 4294967295) throw new Error("max chunk length is too large");
    ...
    StreamEncryptor.prototype.encryptChunk = function(chunk, isLast) {
        ...
        if (chunkLen > this._maxChunkLength) throw new Error("chunk is too large: " + chunkLen + " / " + this._maxChunkLength);
        ...
        encryptedChunk[0] = chunkLen >>> 0 & 255;
        encryptedChunk[1] = chunkLen >>> 8 & 255;
        encryptedChunk[2] = chunkLen >>> 16 & 255;
        encryptedChunk[3] = chunkLen >>> 24 & 255;
    ...
    StreamDecryptor.prototype.decryptChunk = function(encryptedChunk, isLast) {
        ...
        if (crypto_secretbox_open(this._out, this._in, encryptedChunkLen + BOXZEROBYTES - 4, this._fullNonce, this._key) !== 0) return this._fail();
        incrementChunkCounter(this._fullNonce);
    ...
    return {
        createEncryptor: function(k, n, c) {
            return new StreamEncryptor(k, n, c);
        },
        createDecryptor: function(k, n, c) {
            return new StreamDecryptor(k, n, c);
        },
...
function scrypt(password, salt, logN, r, dkLen, interruptStep, callback, encoding) {
    ...
    if (!interruptStep) interruptStep = 1e3;
    smixStart();
    interruptedFor(0, N, interruptStep * 2, smixStep1, function() {
        interruptedFor(0, N, interruptStep * 2, smixStep2, function() {
            smixFinish();
            var result = PBKDF2_HMAC_SHA256_OneIter(password, B, dkLen);
            if (encoding == "base64") callback(bytesToBase64(result)); else if (encoding == "hex") callback(bytesToHex(result)); else callback(result);
        });
    });
}
...
(function() {
    var w, o, r, x, J, K, L, M, N, O, P, Q, y, q, z, R, S, T, U, V, W;
    P = function(b) {
        var a, d;
        d = [];
        for (a in b) d.push(a);
    ...
    N = function(b, a) {
        ...
        e = b.length;
        f = b.toLowerCase();
        for (d = j = 0; 0 <= e ? j < e : j > e; d = 0 <= e ? ++j : --j) for (c = k = d; d <= e ? k < e : k > e; c = d <= e ? ++k : --k) if (f.slice(d, +c + 1 || 9e9) in a) i = f.slice(d, +c + 1 || 9e9), 
        g = a[i], h.push({
            pattern: "dictionary",
            i: d,
            j: c,
    ...
    Q = function(b) {
        ...
        d = function(a) {
            ...
            for (j = a.length; h < j; h++) g = a[h], b = function() {
                ...
                c = [];
                i = b = 0;
                for (a = g.length; b < a; i = ++b) e = g[i], c.push([ e, i ]);
                return c;
            }(), b.sort(), d = function() {
                var a, c, d;
                d = [];
            ...
            if (a.length) {
                ...
                for (n = r.length; l < n; l++) {
                    ...
                    for (o = j.length; p < o; p++) {
                        ...
                        -1 === f ? (f = k.concat([ [ a, e ] ]), i.push(f)) : (g = k.slice(0), g.splice(f, 1), 
                        g.push([ a, e ]), i.push(k), i.push(g));
                    }
                }
                j = d(i);
                return c(h);
        ...
        for (i = 0; i < b.length - 1; ) {
            ...
            for (m = p = 0; ;) {
                ...
                if (j < b.length) {
                    f = b.charAt(j);
                    s = 0;
                    for (n = e.length; s < n; s++) if (c = e[s], g += 1, c && -1 !== c.indexOf(f)) {
                        h = !0;
                        1 === c.indexOf(f) && (m += 1);
                        k !== g && (p += 1, k = g);
                        break;
    ...
    M = function(b) {
        ...
        for (m = s.length; k < m; k++) {
            ...
            l = 0;
            for (p = c.length; l < p; l++) a = c[l], f = parseInt(a.day), i = parseInt(a.month), 
            j = parseInt(a.year), f = x(f, i, j), d = f[0], j = f[1], f = j[0], i = j[1], j = j[2], 
            d && e.push({
                pattern: "date",
                i: a.i,
                j: a.j,
    ...
    L = function(b) {
        ...
        k = [];
        i = 0;
        for (j = e.length; i < j; i++) c = e[i], a = x(c.day, c.month, c.year), g = a[0], 
        h = a[1], a = h[0], f = h[1], h = h[2], g && k.push({
            pattern: "date",
            i: c.i,
            j: c.j,
    ...
    var X, Y, Z, $, C, aa, ba, ca, da, ea, fa, ga, ha, ia, n, ja, t, ka, D, la, ma, na;
    t = function(b, a) {
        var d, c, e;
        if (a > b) return 0;
        if (0 === a) return 1;
        for (d = e = c = 1; 1 <= a ? e <= a : e >= a; d = 1 <= a ? ++e : --e) c *= b, c /= d, 
        b -= 1;
        return c;
    };
    n = function(b) {
    ...
    ja = function(b, a) {
        ...
        for (m = b.length; 0 <= m ? i < m : i > m; f = 0 <= m ? ++i : --i) {
            ...
            d[f] = null;
            j = 0;
            for (l = a.length; j < l; j++) h = a[j], h.j === f && (g = [ h.i, h.j ], e = g[0], 
            g = g[1], e = (k[e - 1] || 0) + aa(h), e < k[g] && (k[g] = e, d[g] = h));
        }
        i = [];
        ...
        j = [];
        l = 0;
        for (m = i.length; l < m; l++) h = i[l], g = [ h.i, h.j ], e = g[0], g = g[1], 0 < e - f && j.push(d(f, e - 1)), 
        f = g + 1, j.push(h);
    ...
    ma = function(b) {
        var a, d, c, e, f, g, h, i, j, k;
        "qwerty" === (c = b.graph) || "dvorak" === c ? (h = oa, d = pa) : (h = qa, d = ra);
        f = 0;
        a = b.token.length;
        i = b.turns;
    ...
    ia = function(b) {
        ...
        c = g = e = 0;
        for (h = Math.min(a, b); 0 <= h ? g <= h : g >= h; c = 0 <= h ? ++g : --g) e += t(a + b, c);
        return n(e);
    };
    ha = function(b) {
        var a, d, c, e, f, g, h, i, j, k;
    ...
    fa = function(b) {
        return 60 > b ? "instant" : 3600 > b ? "" + (1 + Math.ceil(b / 60)) + " minutes" : 86400 > b ? "" + (1 + Math.ceil(b / 3600)) + " hours" : 2678400 > b ? "" + (1 + Math.ceil(b / 86400)) + " days" : 32140800 > b ? "" + (1 + Math.ceil(b / 2678400)) + " months" : 321408e4 > b ? "" + (1 + Math.ceil(b / 32140800)) + " years" : "centuries";
    };
    var E = {
        "!": [ "`~", null, null, "2@", "qQ", null ],
        '"': [ ";:", "[{", "]}", null, null, "/?" ],
    ...
    A = u.concat([ function(b) {
        ...
        for (m = o.length; j < m; j++) {
            ...
            if (P(g)) break;
            k = 0;
            for (p = u.length; k < p; k++) {
                c = u[k];
                e = V(b, g);
                q = c(e);
                l = 0;
                for (n = q.length; l < n; l++) if (c = q[l], i = b.slice(c.i, +c.j + 1 || 9e9), 
        ...
        for (f = 0; f < b.length; ) {
            g = f + 1;
            m = n = j = null;
            for (l in w) if (k = w[l], c = function() {
                var c, d, e, h;
    ...
    o = function(b, a) {
        ...
        if (null != a) {
            d = e = 0;
            for (f = a.length; 0 <= f ? e < f : e > f; d = 0 <= f ? ++e : --e) H[a[d].toLowerCase()] = d + 1;
        }
        d = R(b);
        d = ja(b, d);
        d.calc_time = I() - c;
