...
(function() {
  ...
  tape("construct a permit to decrypt for a recipient", function(test) {
    var operation, permit, uniqueNonce, _ref2;
    operation = new miniLockLib.EncryptOperation({
      keys: Alice.keys
    });
    _ref2 = operation.permit(Bobby.miniLockID), uniqueNonce = _ref2[0], permit = _ref2[1];
  ...
  tape("recipient can decrypt the key, nonce and hash of the file encoded in their permit", function(test) {
    var decodedFileInfo, decryptedFileInfo, fileInfo, operation, permit, uniqueNonce, _ref2;
    operation = new miniLockLib.EncryptOperation({
      keys: Alice.keys
    });
    _ref2 = operation.permit(Bobby.miniLockID), uniqueNonce = _ref2[0], permit = _ref2[1];
